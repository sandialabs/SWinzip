...
% disp('Running StOMP');
tic
[sol, numIters, I, x_I, activeSet] = SolveStOMP(P, y, 50, 0, 1e-8, x_I0, activeSet0);
ts=toc;
...
% Compute the inverse wavelet tranform based on the StOMP solution and the associated error
xs=V*sol;
